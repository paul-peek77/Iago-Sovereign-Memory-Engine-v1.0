...
- Automated housekeeping for long‑term stability
- Cross‑platform support (Windows + Linux)
- Refactored codebase with improved structure and maintainability

PURPOSE

This project was built to support persona protocols, AI‑adjacent workflows, and long‑term memory systems. It also serves as a demonstration of architectural thinking, refactoring skill, and system‑level design.
